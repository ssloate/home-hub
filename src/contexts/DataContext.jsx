...
export function DataProvider({ children }) {
  ...
  const reopenMaintenanceTask = useCallback((taskTemplate, newDate) => {
  const newTask = {
    ...taskTemplate,
    id: uuidv4(), // Give it a brand new ID
    isActive: true,
    dueDate: new Date(newDate).toISOString(),
    completionHistory: [], // Start fresh history for the new instance
  ...
  // Add a function to clear completed tasks
